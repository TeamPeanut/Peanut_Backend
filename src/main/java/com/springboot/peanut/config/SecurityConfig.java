...
import com.springboot.peanut.handler.CustomAccessDeniedHandler;
import com.springboot.peanut.handler.CustomAuthenticationEntryPoint;
import com.springboot.peanut.jwt.JwtAuthenticationFilter;
    ...
    protected void configure(HttpSecurity httpSecurity) throws Exception {
        httpSecurity.httpBasic().disable() // REST API는 UI를 사용하지 않으므로 기본설정을 비활성화
                ...
                .antMatchers("/api/sign-api/**","/api/auth",
                        "/api/sign-api/exception","/api/auth/**","/api/main-api/**").permitAll() // 가입 및 로그인 주소는 허용
